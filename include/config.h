...
#define SENSORS_TASK_STACKSIZE        (12 * configMINIMAL_STACK_SIZE)
...
#define LPS_DECK_STACKSIZE            (12 * configMINIMAL_STACK_SIZE)
#define OA_DECK_TASK_STACKSIZE        (2 * configMINIMAL_STACK_SIZE)
#define KALMAN_TASK_STACKSIZE         (4 * configMINIMAL_STACK_SIZE)
